...
public class Event implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if(this.date==null && other.date==null){
            return true;
        }else if(this.date==null && other.date!=null || this.date!=null && other.date==null){
            return false;
        }
        int td = this.date.getDay();
        int od = other.date.getDay();
        int tm = this.date.getMonth();
        int om = other.date.getMonth();
        int dy = this.date.getYear();
        int oy = other.date.getYear();
        if ((td==od && tm == om && dy == oy)) {
            return true;
        }
        return false;
    }
