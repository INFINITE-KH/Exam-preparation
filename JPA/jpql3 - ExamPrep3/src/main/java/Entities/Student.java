...
@NamedQueries({
    ...
    , @NamedQuery(name = "Student.findSumBySemester", query = "SELECT  COUNT(s) from Student s WHERE s.currentsemesterId = :currentSemesterID")
    , @NamedQuery(name = "Student.findSum", query = "SELECT COUNT(s) from Student s")})
